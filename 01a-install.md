...
>> I installed Python 3 because it is recommended in the lines above and because Python 3 is the present and future of the language while Python 2 is the legacy.
